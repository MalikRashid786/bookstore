...
?>
  ...
  <li class="nav-item" style="margin-left: 90px">
    <a class="nav-link" href="productshow.php?cateid=<?php echo $row1['cateid'];?>"><?php echo $row1['category']; ?></a>
  </li>
</ul>
<?php 
} 
...
?>
  <div class="col-3-lg" style="display:inline-grid;">
    <div class="card ml-2 mr-1 mt-3" style="width:12rem;">
    ...
    <div class="card-body" style="height: 200px;opacity: 0.2">
      ...
      <a href="#" class="badge badge-success"  style="font-size: 12px"><?php echo $row['rating'];?>*</a><span  style="font-size: 12px">(<?php echo $row['quantity']?>)</span>
      <b  style="font-size: 10px">$<?php echo $row['price']; ?>&nbsp;</b><strike  style="font-size: 10px">&#8377;<?php echo $row['oldprice']; ?></strike><span   style="font-size: 12px">&nbsp;&nbsp;<br/> <?php echo $row['off'];?> Off</span>
      <b style="font-size: 12px"><span style="color: green"><?php echo $row['special']; ?></span></b>
